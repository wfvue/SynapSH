...
const authMethods = [
  { value: "password", label: "密码", icon: "icon-[lucide--key]" },
  { value: "publickey", label: "密钥", icon: "icon-[lucide--file-key-2]" },
  { value: "both", label: "密码 + 密钥", icon: "icon-[lucide--shield-check]" },
];
</script>
...
<template>
  <div class="space-y-7 animate-in fade-in duration-300 pb-8">
    <section>
      <div class="px-2 mb-2">
        <span class="text-[12px] font-semibold text-tertiary">身份验证</span>
      </div>
    ...
    <section>
      <div class="px-2 mb-2">
        <span class="text-[12px] font-semibold text-tertiary">超时与连接</span>
      </div>
      ...
      >
        ...
        >
          <div class="flex flex-col gap-0.5">
            <span class="text-[13px] font-medium text-primary">连接超时 (秒)</span>
            <span class="text-[11px] text-tertiary">等待服务器响应的最长时间</span>
          </div>
          <input
            type="number"
            v-model="timeout"
        ...
        >
          <div class="flex flex-col gap-0.5">
            <span class="text-[13px] font-medium text-primary">心跳间隔 (秒)</span>
            <span class="text-[11px] text-tertiary">保持连接活跃的心跳发送间隔</span>
          </div>
          <input
            type="number"
            v-model="keepAlive"
    ...
    <section>
      <div class="px-2 mb-2">
        <span class="text-[12px] font-semibold text-tertiary">高级控制</span>
      </div>
      ...
      >
        ...
        >
          <div class="flex flex-col gap-0.5">
            <span class="text-[13px] font-medium text-primary">数据压缩</span>
            <span class="text-[11px] text-tertiary">压缩传输数据以节省带宽</span>
          </div>
        ...
        <div
          class="flex items-center justify-between p-3.5 px-4 hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors"
        >
          <span class="text-[13px] font-medium text-primary">SSH 协议版本</span>
          <div
    ...
    <section>
      <div class="px-2 mb-2">
        <span class="text-[12px] font-semibold text-tertiary">自动认证密钥</span>
      </div>
      ...
      <div class="flex flex-col gap-2">
        ...
        >
          ...
          <span class="text-[13px] font-medium">添加本地密钥</span>
        </button>
      </div>
    </section>
  </div>
