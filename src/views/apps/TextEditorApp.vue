  ...
  <div class="text-editor-app">
    ...
    <header class="editor-toolbar">
      <div class="toolbar-left">
        ...
        <button
          class="toolbar-btn"
          @click="editorRef?.trigger('', 'redo', null)"
          title="重做 (⌘⇧Z)"
        >
        ...
        <button
          class="toolbar-btn"
          @click="editorRef?.trigger('', 'actions.find', null)"
          title="查找 (⌘F)"
        >
        ...
        <button
          class="toolbar-btn"
          @click="editorRef?.trigger('', 'editor.action.startFindReplaceAction', null)"
          title="替换 (⌘H)"
        >
    ...
    <main class="editor-container">
      ...
      <VueMonacoEditor
        ...
        @update:value="handleCursorChange"
      />
    </main>
