        ...
        >
          <div class="flex justify-between items-center p-5 border-b border-white/[0.06]">
            <div class="flex items-center gap-3">
              <span
                class="w-12 h-12 bg-gradient-to-br from-sky-400/30 to-sky-400/10 rounded-xl flex items-center justify-center text-2xl font-bold text-sky-400"
                >{{ process.name.charAt(0).toUpperCase() }}</span
              >
          ...
          <div class="flex-1 overflow-y-auto p-5">
            ...
            <div class="grid grid-cols-3 gap-3 mb-6">
              <div class="bg-white/[0.03] border border-white/[0.05] rounded-xl p-4 text-center">
                <span
                  class="block text-[0.7rem] text-muted-foreground uppercase tracking-wider mb-1.5"
                  >状态</span
                >
                <span
            ...
            <div class="mb-6">
              <h4
                class="flex items-center gap-2 text-sm font-medium text-foreground/70 mb-3 pb-2 border-b border-white/[0.05]"
              >
              ...
              <div class="grid grid-cols-2 gap-3">
                ...
                <div class="flex flex-col gap-1">
                  ...
                  <span class="text-sm text-foreground/80"
                    >{{ process.statusDesc }} ({{ process.status }})</span
                  >
                </div>
                <div class="flex flex-col gap-1">
            ...
            <div class="mb-6">
              ...
              <div class="grid grid-cols-2 gap-3">
                <div class="flex flex-col gap-1">
                  ...
                  <span class="text-sm text-foreground/80 font-mono">{{
            ...
            <div class="mb-6">
              ...
              <div class="bg-black/30 border border-white/[0.06] rounded-xl p-3 overflow-x-auto">
                <code class="font-mono text-xs text-sky-400/90 leading-relaxed break-all">{{
                  process.command
                }}</code>
              </div>
            </div>
