...
<template>
  <button
    ...
    :class="{ 'bg-blue-500/30 border-blue-500/40 hover:bg-blue-500/40': selected }"
  ...
  >
    ...
    <span
      class="text-[12px] text-white text-center drop-shadow-md max-w-full truncate px-1 rounded leading-tight"
    >
      {{ item.label }}
    </span>
  </button>
