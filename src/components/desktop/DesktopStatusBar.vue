    ...
    <div class="absolute top-2 inset-x-0 w-full flex justify-center z-50 pointer-events-none">
        <header
            ...
            <div class="flex items-center gap-5">
                ...
                <span
                    class="font-bold tracking-wider text-cyan-50 drop-shadow-[0_0_5px_rgba(255,255,255,0.5)]">SYNAP_SH</span>
                <nav class="flex gap-4 opacity-70">
                    <span class="hover:text-cyan-300 hover:opacity-100 transition-colors cursor-pointer">SYS</span>
                    <span class="hover:text-cyan-300 hover:opacity-100 transition-colors cursor-pointer">NET</span>
                    <span class="hover:text-cyan-300 hover:opacity-100 transition-colors cursor-pointer">SEC</span>
                </nav>
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center opacity-90 cursor-pointer hover:text-cyan-300 hover:drop-shadow-[0_0_5px_rgba(34,211,238,0.8)] transition-all"
                ...
                <div class="flex items-center opacity-90 cursor-pointer hover:text-cyan-300 transition-all"
                    title="Uplink Status">
                    <span class="icon-[mdi--satellite-uplink] text-lg"></span>
                </div>

                <div class="flex items-center opacity-90" title="Core Status">
                    <span class="icon-[mdi--connection] text-lg transition-colors duration-500"
                        :class="{ 'text-emerald-400 drop-shadow-[0_0_5px_rgba(52,211,153,0.8)]': isConnected, 'text-rose-500 drop-shadow-[0_0_5px_rgba(244,63,94,0.8)]': !isConnected }"></span>
                </div>
            </div>
        </header>
    </div>
